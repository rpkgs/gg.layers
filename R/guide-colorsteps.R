...
#'   visible.
#' @inheritDotParams ggplot2::guide_colourbar -nbin -raster -ticks -available_aes
#'
...
#' 
guide_coloursteps2 <- function(even.steps = TRUE, show.limits = NULL, ticks = FALSE, ...) {
  guide <- guide_colourbar2(raster = FALSE, ticks = ticks, nbin = 100, ...)
...
#'
#' @noRd
label_just_defaults.colorbar2 <- function(direction, position) {
